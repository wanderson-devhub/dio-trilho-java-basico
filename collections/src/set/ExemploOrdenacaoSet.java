...
public class ExemploOrdenacaoSet {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n---\tOrdem Gênero\t---");
        Set<Serie> minhasSeries4 = new TreeSet<>(new ComparatorOrdemGenero());
        ...
        Set<Serie> minhasSeries5 = new TreeSet<>(new ComparatorOrdemTempoEpisodio());
...
class ComparatorOrdemGenero implements Comparator<Serie> {
    @Override
    public int compare(Serie s1, Serie s2) {
...
class ComparatorOrdemTempoEpisodio implements Comparator<Serie> {
    @Override
    public int compare(Serie s1, Serie s2) {
        return Integer.compare(s1.getTempoEpisodio(), s2.getTempoEpisodio());
    }
